...
const SignUp = ({ onSwitchMode, onSubmit }) => {
  ...
  return (
    <div className='max-w-md w-full bg-white shadow-lg border border-purple-100 rounded-xl p-8 my-6'>
       ...
       <form onSubmit={handleSubmit} className='space-y-4'>
           {FIELDS.map(({name, type, placeholder, icon: Icon}) => (
              <div key={name} className={Inputwrapper}>
                 ...
                 <input type={type} placeholder={placeholder} value={formData[name]} onChange={
       ...
       <p className='text-center text-sm text-gray-600 mt-6 '>
          ...
          <button onClick={onSwitchMode} className='text-purple-600 hover:text-purple-700
