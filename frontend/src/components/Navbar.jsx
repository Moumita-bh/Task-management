    ...
    <header className='sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans'>
       <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
          ...
          <div className='flex items-center gap-2 cursor-pointer group'
           onClick={() => navigate('/')}>
              {/* LOGO */}
              <div className='relative h-10 w-10 flex items-center justify-center rounded-xl bg-linear-to-br
              ...
              to-indigo-500 bg-clip-text text-transparent tracking-white'>
                 TaskManagement
              </span>
          </div>
          ...
          <div className='flex items-center gap-4'>
               ...
               hover:bg-pink-50 rounded-full' onClick={() => navigate('/profile')}>
               ...
               <div ref={menuref} className='relative'>
                  ...
                  py-4 rounded-full cursor-pointer hover:bg-purple-50 transition-colors duration-300 border
                  border-transparent hover:border-purple-200'>
                     <div className='relative'>
                         {user.avatar ? (
                            ...
                            bg-linear-to-br from from-fuchsia-500 to-purple-600 text-white 
                            font-semibold shadow-md'>
                                {user.name?.[0]?.toUpperCase() || 'U'}
                            </div>
                         )} 
                         <div className='absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-400
                         rounded-full border-white animate-pulse'/>   
                     </div>
