      ...
      <div className={SIDEBAR_CLASSES.desktop}>
          <div className='p-5 border-b border-purple-100 lg:block-hidden'>
              <div className='flex items-center gap-3'>
                 <div className='w-10 h-10 rounded-full bg-linear-to-br from-fuchsia-500 to-purple-600
                       ...
                       <div className={TIP_CARD.container}>
                           <div className='flex items-center gap-2'>
                               ...
                               <div>
                                 ...
                                 target='_blank' className='block text-sm mt-2 text-purple-500 hover:underline'>
                                   Visit Masai School
                                 </a>
                               </div>
                           </div>
