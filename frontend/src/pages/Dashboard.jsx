...
const Dashboard = () => {
  ...
  const handleTaskSave = useCallback(async(taskData) => {
    try {
      if(taskData.id) await axios.put(`${API_BASE}/${taskData.id}/ms`, taskData)
      refreshTasks()
      setShowModal(false)
    ...
    <div className={WRAPPER}>
       ...
       <div className={HEADER}>
            <div className='min-w-0'>
               ...
               <p className='text-sm text-gray-500 ml-7 mt-1 truncate'>Manage your tasks efficiently</p>
            </div>
          ...
          ({
           ...
           <div key={key} className={`${STAT_CARD} ${borderColor}`}>
               <div className='flex items-center gap-2 md:gap-3'>
                    ...
                    <div className='min-w-0'>
                          <p className={`${VALUE_CLASS} ${linear ?
      ...
      <div className='space-y-6'>
                ...
                <div className={EMPTY_STATE.wrapper}>
                    <div className={EMPTY_STATE.iconWrapper}>
                      ...
                      <p className='text-sm text-gray-500 mb-4'>
                       {filter === "all" ? "Create your first task to get started" : "No tasks match this filter"} </p>
           ...
           className='hidden md:flex items-center justify-center p-4 border-2 border-dashed
           border-purple-200 rounded-xl hover:border-purple-400 bg-purple-50/50 cursor-pointer transition-colors'>
